...
Por fim, vamos fazer um paralelo com uma fábrica de brinquedos. A fábrica utiliza algumas matérias-primas, como madeira, plástico e tecido, para fabricar os brinquetos. Nela, existem algumas máquinas que recebem a matéria-prima e transformam em partes dos brinquedos e máquinas que recebem todas as partes e montam o brinquedo, colocando-o dentro de sua embalagem ao final. Nessa metáfora, a matéria-prima representa os valores reativos, as máquinas de produzem as partes são as expressões reativas e a máquina que monta e empacota o brinquedo são os *observers*.
