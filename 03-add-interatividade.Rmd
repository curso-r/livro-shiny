...
A interatividade de um aplicativo Shiny é dada pela relação de *inputs* e *outputs*. Os inputs permitem a pessoa usando o aplicativo enviar informação para o servidor, que é utilizada na construção dos outputs devolvidos para a tela.
